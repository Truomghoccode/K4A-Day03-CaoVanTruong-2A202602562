...
class MCPAcademicServer:
    ...
    """
    def __init__(self, server_name: str = "livestock-farming handbook-mcp-server"):
...
if __name__ == "__main__":
    print("==========================================================")
    print("🔌 KIỂM THỬ ĐỘC LẬP MCP SERVER (livestock-farming handbook-mcp-server)")
    print("==========================================================")
    ...
    sched_tool = next((t for t in tools if t.get("name") == "care_warning"), None)
    if sched_tool and not sched_tool.get("parameters", {}).get("properties"):
        print("⏳ [TODO 1.2]: Tool 'care_warning' chưa được định nghĩa properties trong 'src/tools.py'.")
    else:
        print("✅ [TODO 1.2]: Tool 'care_warning' đã có schema đầy đủ.")

    # Kiểm tra trạng thái TODO 2.1 (call_tool)
    test_result = server.call_tool("chicken_query",{"query": "Đàn gà bỏ ăn, tiêu chảy và thở gấp"})
    if not test_result:
        print("⏳ [TODO 2.1]: Hàm call_tool() đang trả về rỗng. Học viên hãy hoàn thiện TODO 2.1 trong 'src/mcp_server.py'!")
    else:
        print(f"✅ [TODO 2.1]: Test dispatch tool 'chicken_query' thành công:")
